...
class TemplatesWtbp extends ModuleWtbp {
	...
	public function loadJqGrid() {
		...
		if (!$loaded) {
			$this->loadJqueryUi();
			FrameWtbp::_()->addScript('wtbp-jq-grid', $this->_cdnUrl . 'lib/jqgrid/jquery.jqGrid.min.js');
			FrameWtbp::_()->addStyle('wtbp-jq-grid', $this->_cdnUrl . 'lib/jqgrid/ui.jqgrid.css');
