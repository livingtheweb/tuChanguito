(function (vendor, $, window) {
	...
	vendor.initResponsiveMode = (function(objAttr, settings, tableWrapper) {
		var mode = this.checkSettings(settings, 'responsive_mode', 'horizontal'),
			...
			responsiveColumnHidingForce = settings.responsive_column_hiding_force ? settings.responsive_column_hiding_force : false,
            needHide = $(window).width() <= mobileWidth || tableWrapper.find('.wtbpContentTable').width() >= tableWrapper.width();
		switch(mode) {
			case 'responsive':
